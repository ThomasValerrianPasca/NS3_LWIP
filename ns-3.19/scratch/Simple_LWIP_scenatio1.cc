...
main (int argc, char *argv[])
{
	...
	Ipv4Interface::mode=aggregation_mode;
	EpcEnbApplication::mode=aggregation_mode;
...
/*
		...
		sourceApps01.Stop (Seconds (10.0));
...
//        }
  ...
  clientApps.Stop(Seconds(3.0));*/
	...
	p2ph.EnablePcap("Remotehost",internetDevices);
