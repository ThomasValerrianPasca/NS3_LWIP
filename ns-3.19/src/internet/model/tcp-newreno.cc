...
TcpNewReno::NewAck (const SequenceNumber32& seq)
{
  ...
  //std::cout<<"Present time= "<<present<<"Difference = "<<(present-past)<<std::endl;
 // std::cout<<"Past time= "<<past<<std::endl;
 //std::cout<<seq<<","<<m_cWnd  <<std::endl;
  if((present-past)>1)
  {

   past=  Simulator::Now ().GetMilliSeconds ();
   //std::cout<<"**Past time= "<<past<<std::endl;
  //std::cout<<m_cWnd.Get()<<std::endl;
